...
class OTPArgumentEntity {
  ...
  factory OTPArgumentEntity.fromMap(Map<String, dynamic> map) {
    return OTPArgumentEntity(
  ...
  factory OTPArgumentEntity.fromJson(String source) =>
      OTPArgumentEntity.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'OTPArgumentEntity(emailOrPhone: $emailOrPhone, isEmail: $isEmail, isBusiness: $isBusiness, isInitial: $isInitial, isLogin: $isLogin, isEmailIdUpdate: $isEmailIdUpdate, isMobileUpdate: $isMobileUpdate, isReKyc: $isReKyc)';
  }

  @override
  bool operator ==(covariant OTPArgumentEntity other) {
